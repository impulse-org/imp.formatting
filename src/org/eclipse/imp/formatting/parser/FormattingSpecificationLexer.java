...
public class FormattingSpecificationLexer extends LpgLexStream implements FormattingSpecificationParsersym, FormattingSpecificationLexersym, RuleAction, ILexer
{
    private static ParseTable prs = new FormattingSpecificationLexerprs();
    ...
    public FormattingSpecificationLexer(String filename, int tab) throws java.io.IOException 
    {
        super(filename, tab);
    }

    public FormattingSpecificationLexer(char[] input_chars, String filename, int tab)
    {
        super(input_chars, filename, tab);
    }

    public FormattingSpecificationLexer(char[] input_chars, String filename)
    {
        this(input_chars, filename, 1);
    }

    public FormattingSpecificationLexer() {}

    public String[] orderedExportedSymbols() { return FormattingSpecificationParsersym.orderedTerminalSymbols; }
    ...
    //
    FormattingSpecificationKWLexer kwLexer;
    boolean printTokens;
    private final static int ECLIPSE_TAB_VALUE = 4;

    public int [] getKeywordKinds() { return kwLexer.getKeywordKinds(); }

    public FormattingSpecificationLexer(String filename) throws java.io.IOException
    {
        this(filename, ECLIPSE_TAB_VALUE);
        this.kwLexer = new FormattingSpecificationKWLexer(getInputChars(), TK_IDENTIFIER);
    }
