...
%options filter=FormattingSpecificationKWLexer.gi
--
-- This is just a sample lexer and not a real lexer for FormattingSpecification
--
...
%Define
    ...
    $kw_lexer_class /.$FormattingSpecificationKWLexer./
%End
